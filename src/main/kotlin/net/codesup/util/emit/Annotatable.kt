...
interface Annotatable {
    ...
    fun annotate(remainingName: QualifiedName, block: AnnotationUse.() -> Unit): AnnotationUse = AnnotationUse(ClassTypeUse(remainingName)).apply(block).apply{ annotations.add(this) }
    ...
    fun <T:Annotation> annotate(annotationClass: kotlin.reflect.KClass<T>, block: AnnotationUse.() -> Unit = {}) = AnnotationUse(KClassUse<T>(annotationClass)).apply(block).apply { annotations.add(this) }
